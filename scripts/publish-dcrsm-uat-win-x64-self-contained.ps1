...
$output = Join-Path $root 'publish\DCRSM_UAT_win-x64_self-contained'
...
Write-Host "Published self-contained package to: $output"
Write-Host "Copy the ENTIRE folder to DCRSM server, not only Acbs.Vsdc.TestHub.exe."
